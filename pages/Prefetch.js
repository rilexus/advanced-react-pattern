        ...
        <article>
          <div>
            ...
            <P>
              ...
              getting data does not do any harm in the majority of cases. It has
              one fault tho. Its the fetching on mount. To make make case clear,
              Ill provide couple of examples.
            </P>
            <P>
              The &quot;sequence fetch&quot; and the &quot;parallel fetch&quot;
              examples have the same structure:
            </P>
            <figure>
              <Code>
                {"const Component = () => {\n" +
            ...
            <P>
              One thing they have certainly in common. They render its children
              as soon as the data is available. The difference is that the
              sequence example fetches, as the naming suggest, in sequence: on
              mount, while the parallel example fetches all needed data
              parallel, even before react starts rendering anything.
            </P>
            <P>
            ...
            <P>
              And the implementation of the parallel component looks like this:
            </P>
            <figure>
              <Code>
            ...
            <P>If we run them side by side, the difference is pretty clear.</P>
          </div>
          ...
          <P>
            The parallel fetching is always faster. If you need to fetch data on
            mount, I would suggest you not to do that. Prefetch the data and
            rerender as soon as data is available.
          </P>
          <P>
