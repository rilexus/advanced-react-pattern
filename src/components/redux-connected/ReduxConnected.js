    ...
    <div>
      ...
      <div>
        ...
        <div>
          ...
          <input  id={'normal'} type="text" onChange={({target:{value}})=>setName(value)}/>
        </div>
        ...
        <div>
          ...
          <input id={'async'} type="text" onChange={({target:{value}})=>asyncSetName(value)}/>
        </div>
...
export const ReduxConnected = connect(mapStateToProps,mapDispatchToProps)(_ReduxConnected);